...
BASE_CRAIGSLIST_URL = 'https://toronto.craigslist.org/d/services/search/bbb?query={}&min_price={}&max_price={}'
...
def new_search(request):
   ...
   final_url = BASE_CRAIGSLIST_URL.format(quote_plus(search), min_price, max_price)
